...
const Sidebar = ({ showSizeBar, onClick }) => {
  ...
  return (
    ...
    >
      <div className="w-[320px] h-screen transition duration-1000 overflow-clip flex flex-col">
        <nav className="w-full mx-auto flex flex-col bg-transparent py-[18px] px-6 flex-grow">
          ...
          <div className="flex flex-col gap-[30px] text-[#00070E] ">
        ...
        <div className="flex items-center justify-center p-4">
          <button className="w-full gradient-bg cta-text text-white rounded-[32px] flex items-center justify-center hover:opacity-95 hover:scale-105 hover:!text-black transition-all duration-200 h-[42px]">
            Contact Us
          </button>
        </div>
      </div>
